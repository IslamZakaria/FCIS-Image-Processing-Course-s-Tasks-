function expectedArray = DetectUselessBits(Img, Per)
...
if zeroFirst < (Per * totalPixelNo)
    expectedArray = [expectedArray 1];
end
if zeroSecond < (Per * totalPixelNo)
    expectedArray = [expectedArray 2];
end
if zeroThird < (Per * totalPixelNo)
    expectedArray = [expectedArray 3];
end
if zeroFourth < (Per * totalPixelNo)
    expectedArray = [expectedArray 4];
end
if zeroFifth < (Per * totalPixelNo)
    expectedArray = [expectedArray 5];
end
if zeroSixth < (Per * totalPixelNo)
    expectedArray = [expectedArray 6];
end
if zeroSeventh < (Per * totalPixelNo)
    expectedArray = [expectedArray 7];
end
if zeroEighth < (Per * totalPixelNo)
